...
theme.set_highlights = function()
  ...
  hl(0, "Whitespace", { fg = "#FFFFFF", bg = 'NONE' })
  ...
  hl(0, "Function", { fg = "#5599FF", bg = 'NONE' })
  ...
  hl(0, "Delimiter", { fg = "#FFFFFF", bg = 'NONE' })
  ...
  hl(0, "Identifier", { fg = "#FFFFFF", bg = 'NONE' })
  ...
  hl(0, "TSField", { fg = "#FFFFFF", bg = 'NONE' })
  hl(0, "TSProperty", { fg = "#FF5555", bg = 'NONE' })
